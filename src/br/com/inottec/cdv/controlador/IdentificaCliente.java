...
public class IdentificaCliente implements Initializable {
	...
	public static String nomeAdd, CPFadd, controleID;	
	...
	public static String getControleID() {
		return controleID;
	}

	public static void setControleID(String controleID) {
		IdentificaCliente.controleID = controleID;
	}

	public static String getNomeAdd() {
		return nomeAdd;
	}

	public static void setNomeAdd(String nomeAdd) {
		IdentificaCliente.nomeAdd = nomeAdd;
	}

	public static String getCPFadd() {
		return CPFadd;
	}

	public static void setCPFadd(String cPFadd) {
		CPFadd = cPFadd;
	}
	...
	void botaoIdentificar(ActionEvent event) throws IOException {
		...
		setCPFadd(tabelaClientes.getSelectionModel().getSelectedItem().getCpf().toString());
		setNomeAdd(tabelaClientes.getSelectionModel().getSelectedItem().getNome().toString());
		
		controleID = "botaoIdentificar";
	...
	private void carregarSelecao(ActionEvent event) {
		...
		tabelaPane.getSelectionModel().select(1);
	...
	// ====================== metodos que cria uma mascara no campodo assim que é
	// digitado no campo ===============
